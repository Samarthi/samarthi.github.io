...
const CACHE_NAME = "CS-cache";
const OFFLINE_URL = "CS.offline.html";
// Files that will be cached on load.
const CACHED_FILES = ["CS.html","CS.js","CS.wasm","CS.pck","CS.offline.html","CS.icon.png","CS.apple-touch-icon.png"];
